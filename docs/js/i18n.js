...
var I18n = (() => {
  ...
  const builtinTranslations = {
    'zh-CN': {
      ...
      'menu.toggleLineNumbers': '显示/隐藏行号', 'menu.zoomIn': '放大字体', 'menu.zoomOut': '缩小字体',
      'menu.resetZoom': '重置字体大小', 'menu.toggleTheme': '切换主题',
      ...
      'dialog.insertImage': '插入图片', 'dialog.imageAlt': '替代文本', 'dialog.imageURL': '图片 URL',
    ...
    'en-US': {
      ...
      'menu.toggleLineNumbers': 'Toggle Line Numbers', 'menu.zoomIn': 'Zoom In', 'menu.zoomOut': 'Zoom Out',
      ...
      'dialog.insertImage': 'Insert Image', 'dialog.imageAlt': 'Alt Text', 'dialog.imageURL': 'Image URL',
