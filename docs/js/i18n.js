...
var I18n = (() => {
  ...
  const builtinTranslations = {
    'zh-CN': {
      ...
      'menu.printPreview': '打印预览', 'menu.print': '打印', 'menu.close': '关闭', 'menu.closeAll': '关闭所有', 'menu.exit': '退出',
    ...
    'en-US': {
      ...
      'menu.printPreview': 'Print Preview', 'menu.print': 'Print', 'menu.close': 'Close', 'menu.closeAll': 'Close All', 'menu.exit': 'Exit',
